# -*- coding: utf-8 -*-
"""
Created on Tue Jan  8 15:57:43 2019
...
def forward_propagation(x, theta):
    """
    Implement the linear forward propagation (compute J) in J(theta) = theta * x
    Arguments:
        x -- a real-valued input
        theta -- our parameter, a real number as well
    Returns:
        J -- the value of function J, computing using the formula J(theta) = theta * x
    """
    J = theta * x 
    return J
"""
...
def gradient_check_n(parameters, gradients, X, Y, epsilon = 1e-7):
    ...
    for i in range(num_parameters):
        ...
        # "_" is used because the function has to outputs two parameters but we only care about the first one
    ...
    if difference > 2e-7:
        ...
        print("033[92m" + "Your backward propagation works prefectly fine! difference = " + str(difference) + "\033[0m")
