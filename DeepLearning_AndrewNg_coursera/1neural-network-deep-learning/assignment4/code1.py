...
def initialize_parameters_deep(layer_dims):
    ...
    Returns:
        parameters -- python dictionary containing your parameters "W1", "b1", ..., "WL", "bL":
            Wl -- weight matrix of shape (layer_dims[l], layer_dimes[l-1])
...
def linear_activation_forward(A_prev, W, b, activation):
    ...
    Arguments:
        ...
        W -- weights matrix: numpy array of shape (size of current layer, size of previous layer)
        b -- bias vector, number array of shape (size of the current layer, 1)
...
def L_model_forward(X, parameters):
    ...
    # Implement [LINEAT->RELU]*(L-1). Add "cache" to the "caches" list
    for l in range (1, L):
        A_prev = A
...
def compute_cost(AL, Y):
    ...
    # Compute the loss from AL and Y
...
def L_model_backward(AL, Y, caches):
    """
    Implement the backward propagation for the [LINEAT->RELU]*(L-1) -> LINEAR->SIGMOID group
    Arguments:
